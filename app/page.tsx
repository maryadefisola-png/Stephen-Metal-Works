    ...
    <main>
      <nav className="nav">
        ...
        <div className={`navlinks ${menu ? 'open' : ''}`}>
          <a href="#services" onClick={() => setMenu(false)}>Services</a><a href="#studio" onClick={() => setMenu(false)}>AI Design Studio</a><a href="#work" onClick={() => setMenu(false)}>Our Work</a><a href="#contact" onClick={() => setMenu(false)}>Contact</a>
        </div>
        <a className="navcta" href={whatsapp} target="_blank">WhatsApp Us ↗</a><button className="menubtn" onClick={() => setMenu(!menu)} aria-label="Toggle menu">☰</button>
      </nav>

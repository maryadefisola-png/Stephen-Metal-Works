...
export default function Home() {
  ...
  const [quoteDesign, setQuoteDesign] = useState<QuoteDesign | null>(null)
  ...
  return (
    <main>
      ...
      <section className="quote section" id="quote"><div className="quoteinner"><div className="sectiontag">REQUEST A QUOTE</div><h2>Tell us what you want.<br /><em>We'll take it from there.</em></h2><p>{quoteDesign ? 'Your AI concept and generated visual are attached to this quote request. Add your contact details and send it to Stephen Metal Works.' : 'Give us the basic details below. You can describe your idea even if you do not have a picture.'}</p><QuoteForm design={quoteDesign} /></div></section>
